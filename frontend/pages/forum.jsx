        ...
        <div className="antialiased">
          <div className="min-h-screen flex">
            ...
            <main className="grow overflow-hidden">
              ...
              <Hero title="Dao Community forum " description="Respectful and good-faith discussion should be the cornerstone of any decision-making process. In trying to enact change, please keep this principle in mind." />
